...
`,jpDateField=DateField.compose({baseName:"date-field",styles:dateFieldStyles,template:dateFieldTemplate,shadowOptions:{delegatesFocus:!0}});var divider=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/divider/divider.js"),divider_template=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/divider/divider.template.js"),divider_styles=__webpack_require__("../../node_modules/@microsoft/fast-components/dist/esm/divider/divider.styles.js");const jpDivider=divider.i.compose({baseName:"divider",template:divider_template.q,styles:divider_styles.T});var listbox_element=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/listbox/listbox.element.js"),listbox_template=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/listbox/listbox.template.js"),listbox_option=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/listbox-option/listbox-option.js");const listboxStyles=(context,definition)=>{const ListboxOptionTag=context.tagFor(listbox_option.wt),hostContext=context.name===context.tagFor(listbox_element.k)?"":".listbox";return css.i`
        ${hostContext?"":(0,display.j)("inline-flex")}

        :host ${hostContext} {
            background: ${esm_design_tokens.If};
            border: calc(${esm_design_tokens.H} * 1px) solid ${esm_design_tokens.ak};
            border-radius: calc(${esm_design_tokens.UW} * 1px);
            box-sizing: border-box;
            flex-direction: column;
        ...
        ${hostContext?"":css.i`
            :host(:${style_focus.b}:not([disabled])) {
                outline: none;
            }

            :host(:focus-within:not([disabled])) {
                border-color: ${esm_design_tokens.yG};
                box-shadow: 0 0 0
                    calc((${esm_design_tokens.vx} - ${esm_design_tokens.H}) * 1px)
                    ${esm_design_tokens.yG} inset;
            }
        ...
        ${hostContext||":host([size])"} {
            max-height: calc(
                (var(--size) * ${heightNumber} + (${esm_design_tokens._5} * ${esm_design_tokens.H} * 2)) * 1px
            );
            overflow-y: auto;
        }
    ...
    `.withBehaviors((0,match_media_stylesheet_behavior.vF)(css.i`
                :host(:not([multiple]):${style_focus.b}) ::slotted(${ListboxOptionTag}[aria-selected="true"]),
                :host([multiple]:${style_focus.b}) ::slotted(${ListboxOptionTag}[aria-checked="true"]) {
                    border-color: ${system_colors.H.ButtonText};
                    box-shadow: 0 0 0 calc(${esm_design_tokens.vx} * 1px) inset ${system_colors.H.HighlightText};
                }
            ...
            `))},jpListbox=listbox_element.k.compose({baseName:"listbox",template:listbox_template.K,styles:listboxStyles});var menu=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/menu/menu.js"),menu_template=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/menu/menu.template.js"),menu_styles=__webpack_require__("../../node_modules/@microsoft/fast-components/dist/esm/menu/menu.styles.js");const jpMenu=menu.v.compose({baseName:"menu",template:menu_template.K,styles:menu_styles.J});var menu_item=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/menu-item/menu-item.js"),menu_item_template=__webpack_require__("../../node_modules/@microsoft/fast-foundation/dist/esm/menu-item/menu-item.template.js");const menuItemStyles=(context,definition)=>css.i`
