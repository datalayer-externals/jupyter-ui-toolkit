...
`.withBehaviors((0,match_media_stylesheet_behavior.vF)(css.i`
  ...
  :host([aria-pressed='true']) {
    box-shadow: inset 0px 0px 5px 5px ${esm_design_tokens.hP};
    scale: 0.95;
  }
...
`.withBehaviors((0,match_media_stylesheet_behavior.vF)(css.i`
  ...
  :host([appearance='accent'][aria-pressed='true']) {
    box-shadow: inset 0px 0px 5px 5px ${design_tokens.VN};
  }
...
`.withBehaviors((0,match_media_stylesheet_behavior.vF)(css.i`
  ...
  :host([appearance='error'][aria-pressed='true']) {
    box-shadow: inset 0px 0px 5px 5px ${design_tokens.DV};
  }
...
//# sourceMappingURL=main.f843f080.iframe.bundle.js.map