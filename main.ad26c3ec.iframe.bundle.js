...
`.withBehaviors((0,match_media_stylesheet_behavior.vF)(css.i`
  ...
  `.withBehaviors((0,match_media_stylesheet_behavior.vF)(css.i`
    ...
    :host([autowidth]) ::slotted(option) {
      padding: 0 calc(1em + ${esm_design_tokens._5} * 1.25px + 1px);
    }
...
//# sourceMappingURL=main.ad26c3ec.iframe.bundle.js.map